...
| 34 | RS Hermina OPI Jakabaring | RS | Rambutan | -3.0338819 | 104.7909939 | **Sebelumnya NULL di geocoding.** Secara administratif di Kab. Banyuasin, bukan Kota Palembang — lihat poin 3 di atas |
| 1 | Puskesmas Padang Selasa | Ilir Barat I | -2.9901710 | 104.7342989 | |
| 2 | Puskesmas Multiwahana | Sako | -2.9287047 | 104.7805291 | **Sebelumnya NULL di geocoding** |
...
| 9 | Puskesmas Bukitsangkal | Kalidoni | -2.9376611 | 104.7805515 | **Sebelumnya NULL di geocoding** |
...
| 13 | Puskesmas Lima Ilir | Ilir Timur II | -2.9650818 | 104.7727007 | **Sebelumnya NULL di geocoding.** Google Maps: "Puskesmas 5 Ilir" |
...
| 21 | Puskesmas Dua Puluh Tiga Ilir | Bukit Kecil | -2.9878927 | 104.7548896 | Google Maps: "Puskesmas 23 Ilir" |
...
| 26 | Puskesmas Satu Ulu | Seberang Ulu I | -3.0114460 | 104.7519710 | Google Maps: "Puskesmas KIP Unit 1" |
...
| 36 | Puskesmas OPI | Rambutan | -3.0485100 | 104.7848420 | Secara administratif di Kab. Banyuasin — lihat poin 3 di atas. Google Maps: "Puskesmas Ogan Permata Indah" |
| 37 | Puskesmas Kampus | Ilir Barat I | -2.9755074 | 104.7383431 | |
| 38 | Puskesmas Pakjo | Ilir Barat I | -2.9635811 | 104.7344444 | |
| 39 | Puskesmas Ariodillah | Ilir Timur I | -2.9640104 | 104.7426207 | Google Maps: "PHC Ariodillah" |
| 40 | Puskesmas Sebelas Ilir | Ilir Timur II | -2.9811092 | 104.7673902 | Google Maps: "Puskesmas 11 Ilir" |
| 41 | Puskesmas Basuki Rahmat | Kemuning | -2.9481851 | 104.7490356 | |
| 42 | Puskesmas Empat Ulu | Seberang Ulu I | -3.0069681 | 104.7609593 | Google Maps: "Puskesmas 4 Ulu" |
"""
...
for line in markdown_text.strip().split('\n'):
    ...
    if len(parts) >= 7 and parts[1].isdigit():
        ...
        # Check if RS or Puskesmas to get Kecamatan
        if len(parts) >= 8 and "RS" in parts[3]: 
             kecamatan = parts[4]
             lat = parts[5]
             lng = parts[6]
        else:
