...
<?php endif; ?>
        ...
        <div class="absolute top-4 right-4 z-[1000] pointer-events-none">
            <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'pointer-events-auto shadow-2xl backdrop-blur-md bg-surface/95 border border-outline-variant/30 w-72 transition-all duration-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'pointer-events-auto shadow-2xl backdrop-blur-md bg-surface/95 border border-outline-variant/30 w-72 transition-all duration-300']); ?>
                    ...
                    <div class="p-3 rounded-lg border border-outline-variant/50 bg-surface-container mt-2">
                        ...
                        <select id="ai-courier-select" class="w-full bg-background border border-outline-variant/50 rounded p-1.5 text-xs text-on-surface focus:border-primary focus:ring-1 focus:ring-primary outline-none mb-3">
                            ...
                            <?php $__currentLoopData = $perjalananAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id_rute); ?>" data-name="<?php echo e(strtolower($p->kurir->nama_lengkap)); ?>"><?php echo e($p->kurir->nama_lengkap); ?> (<?php echo e($p->lokasi_tujuan); ?>)</option>
                ...
                <div class="p-lg overflow-y-auto flex-1 bg-surface flex flex-col gap-xl">
                    ...
                    <div>
                        <h4 class="font-bold text-sm text-on-surface mb-3 flex justify-between items-center">
                            ...
                            <span class="text-[10px] font-normal px-2 py-0.5 rounded bg-surface-variant text-on-surface-variant"><?php echo e(count($boxes)); ?> Box Ditemukan</span>
                        </h4>
...
<script>
    ...
    activeRoutes = <?php echo json_encode($activeRoutesData); ?>;
    ...
    function pollLiveLocation() {
        let url = '<?php echo e(route("fleet.live")); ?>';
        if (isInitialFetch) {
