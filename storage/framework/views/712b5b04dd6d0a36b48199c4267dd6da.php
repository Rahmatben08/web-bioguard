<?php $__env->startSection('title', 'Manajemen Inventaris Cold Storage Faskes'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-sky-500/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-sky-500/50']); ?>
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900 dark:text-white tabular-nums mt-1"><?php echo e($totalHubs); ?></h3>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-teal-500/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-teal-500/50']); ?>
            <div class="flex justify-between items-start">
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900 dark:text-white tabular-nums mt-1"><?php echo e(number_format($avgTemp, 1, ',', '.')); ?>°C</h3>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-rose-500/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-rose-500/50']); ?>
            <div class="flex justify-between items-start">
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold tabular-nums mt-1 <?php if($alertCount > 0): ?> text-rose-500 dark:text-rose-400 <?php else: ?> text-slate-900 dark:text-white <?php endif; ?>">
                    <?php echo e($alertCount); ?> <span class="text-[11px] font-semibold text-slate-400 dark:text-slate-500">Hub Terdeteksi</span>
                </h3>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-amber-500/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-amber-500/50']); ?>
            <div class="flex justify-between items-start">
                ...
                <span class="text-xs font-bold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 px-2.5 py-1 rounded-lg">
                    <?php echo e($avgCapacityUtil); ?>% terisi
                </span>
            </div>
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900 dark:text-white tabular-nums mt-1">
                    <?php echo e(number_format($totalVaccines, 0, ',', '.')); ?><span class="text-[11px] font-semibold text-slate-400 dark:text-slate-500"> / <?php echo e(number_format($totalCapacity, 0, ',', '.')); ?> Vial</span>
                </h3>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'lg:col-span-12']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['class' => 'lg:col-span-12']); ?>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="text-xl font-black text-slate-900 dark:text-white tabular-nums"><?php echo e(number_format($totalPfizer, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full mt-2 overflow-hidden">
                        <div class="bg-sky-500 h-1.5 rounded-full" style="width: <?php echo e(($totalPfizer / $totalVaccines) * 100); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="text-xl font-black text-slate-900 dark:text-white tabular-nums"><?php echo e(number_format($totalPolio, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full mt-2 overflow-hidden">
                        <div class="bg-indigo-500 h-1.5 rounded-full" style="width: <?php echo e(($totalPolio / $totalVaccines) * 100); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="text-xl font-black text-slate-900 dark:text-white tabular-nums"><?php echo e(number_format($totalSinovac, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full mt-2 overflow-hidden">
                        <div class="bg-emerald-500 h-1.5 rounded-full" style="width: <?php echo e(($totalSinovac / $totalVaccines) * 100); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="text-xl font-black text-slate-900 dark:text-white tabular-nums"><?php echo e(number_format($totalInsulin, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Pena/Vial</span></div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full mt-2 overflow-hidden">
                        <div class="bg-amber-500 h-1.5 rounded-full" style="width: <?php echo e(($totalInsulin / $totalVaccines) * 100); ?>%"></div>
                    </div>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['noPadding' => 'true','class' => 'overflow-hidden transition-colors duration-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['noPadding' => 'true','class' => 'overflow-hidden transition-colors duration-300']); ?>
        <!-- Control Header -->
        <div class="p-4 border-b border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-50/50 dark:bg-slate-900/40">
            ...
            <form action="<?php echo e(route('inventory')); ?>" method="GET" class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                <!-- Search -->
                <div class="relative w-full sm:w-60">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[18px] text-slate-400">search</span>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama faskes/alat..." 
                ...
                <select name="kecamatan" onchange="this.form.submit()" 
                    ...
                    <?php $__currentLoopData = $allKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kec); ?>" <?php echo e(request('kecamatan') === $kec ? 'selected' : ''); ?>><?php echo e($kec); ?></option>
                ...
                <select name="status" onchange="this.form.submit()" 
                    ...
                    <option value="Aman" <?php echo e(request('status') === 'Aman' ? 'selected' : ''); ?>>Aman (2°C - 8°C)</option>
                    <option value="Bahaya" <?php echo e(request('status') === 'Bahaya' ? 'selected' : ''); ?>>Anomali / Bahaya</option>
                </select>

                <!-- Sort option -->
                <select name="sort" onchange="this.form.submit()" 
                        class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-700 dark:text-slate-200 rounded-xl py-1.5 pl-3 pr-8 focus:ring-1 focus:ring-sky-500 focus:border-sky-500 transition-all duration-300">
                    <option value="nama" <?php echo e(request('sort') === 'nama' ? 'selected' : ''); ?>>Urut: Nama Faskes</option>
                    <option value="suhu" <?php echo e(request('sort') === 'suhu' ? 'selected' : ''); ?>>Urut: Suhu Aktual</option>
                    <option value="kapasitas" <?php echo e(request('sort') === 'kapasitas' ? 'selected' : ''); ?>>Urut: Utilitasi Ruang</option>
                    <option value="stok_total" <?php echo e(request('sort') === 'stok_total' ? 'selected' : ''); ?>>Urut: Total Stok</option>
                </select>

                <!-- Reset Button -->
                <?php if(request()->anyFilled(['search', 'kecamatan', 'status', 'sort'])): ?>
                    <a href="<?php echo e(route('inventory')); ?>" class="text-rose-500 hover:text-rose-600 dark:hover:text-rose-400 p-2 hover:bg-rose-500/10 rounded-xl text-xs font-bold transition-all active:scale-95 duration-100 flex items-center gap-1 cursor-pointer">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['class' => 'w-full min-w-[1000px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full min-w-[1000px]']); ?>
                <thead>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>ID / Nama Hub Faskes <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Model Kulkas <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal1291f4dfa458a95c228b06c14d34e160 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1291f4dfa458a95c228b06c14d34e160 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.th','data' => ['class' => 'text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.th'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>Suhu Aktual <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal1291f4dfa458a95c228b06c14d34e160 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1291f4dfa458a95c228b06c14d34e160 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.th','data' => ['class' => 'w-[180px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.th'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-[180px]']); ?>Kapasitas Terisi <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>Rincian Stok (Vial) <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Last Sync <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>Aksi <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php endif; ?>
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800 transition-all duration-300">
                    <?php $__empty_1 = true; $__currentLoopData = $hubsPaginated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if (isset($component)) { $__componentOriginal81a8447ad92ff961a7b67f11577037a1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal81a8447ad92ff961a7b67f11577037a1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.tr','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.tr'); ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-3">
                                    <div class="p-2.5 <?php if($hub['jenis'] === 'Rumah Sakit'): ?> bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400 <?php else: ?> bg-teal-100 text-teal-600 dark:bg-teal-900/30 dark:text-teal-400 <?php endif; ?> rounded-xl">
                                        <span class="material-symbols-outlined text-[18px]">
                                            <?php if($hub['jenis'] === 'Rumah Sakit'): ?> local_hospital <?php else: ?> medical_services <?php endif; ?>
                                        </span>
                                    </div>
                                    <div>
                                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono"><?php echo e($hub['id']); ?></span>
                                        <h4 class="font-bold text-slate-900 dark:text-white text-sm mt-0.5"><?php echo e($hub['nama']); ?></h4>
                                        <span class="text-[10px] text-slate-500 mt-1 inline-flex items-center gap-1 font-semibold">
                                            <span class="material-symbols-outlined text-[11px]">location_on</span> <?php echo e($hub['kecamatan']); ?>
...
<?php $component->withAttributes(['class' => 'font-medium']); ?>
                                <span class="font-semibold text-slate-900 dark:text-white"><?php echo e($hub['kulkas_farmasi']); ?></span>
                                <div class="text-[10px] text-slate-500 font-mono mt-0.5 font-bold">Kapasitas: <?php echo e(number_format($hub['kapasitas_total'], 0, ',', '.')); ?> Vial</div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['class' => 'text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['color' => 'success']); ?>
                                        ...
                                        <?php echo e(number_format($hub['suhu_aktual'], 1, ',', '.')); ?>°C
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex justify-between items-center text-[10px] font-bold text-slate-500 mb-1 font-mono">
                                    <span><?php echo e(number_format($hub['stok_total'], 0, ',', '.')); ?> Vial</span>
                                    <span><?php echo e($hub['kapasitas_persen']); ?>%</span>
                                </div>
                                <div class="w-full bg-slate-200 dark:bg-slate-700 h-2 rounded-full overflow-hidden">
                                    <div class="h-full rounded-full transition-all duration-500 <?php if($hub['kapasitas_persen'] > 90): ?> bg-rose-500 <?php elseif($hub['kapasitas_persen'] > 75): ?> bg-amber-500 <?php else: ?> bg-sky-500 <?php endif; ?>" style="width: <?php echo e($hub['kapasitas_persen']); ?>%"></div>
                                </div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex flex-wrap gap-1.5 justify-center">
                                    <span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold font-mono text-[10px]" title="Pfizer">
                                        P: <span class="text-sky-600 dark:text-sky-400"><?php echo e(number_format($hub['stok']['pfizer'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold font-mono text-[10px]" title="Polio">
                                        O: <span class="text-indigo-600 dark:text-indigo-400"><?php echo e(number_format($hub['stok']['polio'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold font-mono text-[10px]" title="Sinovac">
                                        S: <span class="text-emerald-600 dark:text-emerald-400"><?php echo e(number_format($hub['stok']['sinovac'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold font-mono text-[10px]" title="Insulin">
                                        I: <span class="text-amber-600 dark:text-amber-400"><?php echo e(number_format($hub['stok']['insulin'], 0, ',', '.')); ?></span>
                                    </span>
                                </div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['class' => 'text-slate-500 font-bold font-mono text-[11px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-slate-500 font-bold font-mono text-[11px]']); ?>
                                <?php echo e($hub['last_sync']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <button type="button" onclick="openDetailsModal(<?php echo e(json_encode($hub)); ?>)" 
...
<?php $component->withAttributes([]); ?>
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['colspan' => '7','class' => 'py-8 text-center text-slate-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '7','class' => 'py-8 text-center text-slate-500']); ?>
...
<?php endif; ?>
        ...
        <div class="px-4 py-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40 flex justify-between items-center transition-colors duration-300">
            <span class="text-xs font-semibold text-slate-500">
                Menampilkan <?php echo e($hubsPaginated->firstItem() ?? 0); ?> - <?php echo e($hubsPaginated->lastItem() ?? 0); ?> dari <?php echo e($hubsPaginated->total()); ?> Hub Faskes
            </span>
            <div class="flex gap-2">
                <?php if($hubsPaginated->onFirstPage()): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($hubsPaginated->previousPageUrl()); ?>" class="px-3.5 py-1.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-600/70 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95">
                        Sebelumnya
                    </a>
                <?php endif; ?>

                <?php if($hubsPaginated->hasMorePages()): ?>
                    <a href="<?php echo e($hubsPaginated->nextPageUrl()); ?>" class="px-3.5 py-1.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-600/70 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95">
                        Berikutnya
                    </a>
                <?php else: ?>
                    <button class="px-3.5 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-lg text-xs font-bold cursor-not-allowed" disabled>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project pkm\bio_guard_backend\resources\views\dashboard\inventory.blade.php ENDPATH**/ ?>