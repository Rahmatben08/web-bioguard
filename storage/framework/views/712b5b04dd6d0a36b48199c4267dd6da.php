...
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-sky-500/50']); ?>
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900  tabular-nums mt-1"><?php echo e($totalHubs); ?></h3>
...
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-teal-500/50']); ?>
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900  tabular-nums mt-1"><?php echo e(number_format($avgTemp, 1, ',', '.')); ?>°C</h3>
...
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-rose-500/50']); ?>
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold tabular-nums mt-1 <?php if($alertCount > 0): ?> text-rose-500  <?php else: ?> text-slate-900  <?php endif; ?>">
                    <?php echo e($alertCount); ?> <span class="text-[11px] font-semibold text-slate-400 ">Hub Terdeteksi</span>
                </h3>
...
<?php $component->withAttributes(['class' => 'lg:col-span-3 flex flex-col justify-between transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-amber-500/50']); ?>
            ...
            <div class="mt-4">
                ...
                <h3 class="text-3xl font-extrabold text-slate-900  tabular-nums mt-1">
                    <?php echo e(number_format($totalVaccines, 0, ',', '.')); ?><span class="text-[11px] font-semibold text-slate-400 "> / <?php echo e(number_format($totalCapacity, 0, ',', '.')); ?> Vial</span>
                </h3>
...
<?php $component->withAttributes(['class' => 'lg:col-span-12']); ?>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="p-4 bg-slate-50  rounded border border-slate-200 ">
                    ...
                    <div class="text-xl font-black text-slate-900  tabular-nums"><?php echo e(number_format($totalPfizer, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                ...
                <div class="p-4 bg-slate-50  rounded border border-slate-200 ">
                    ...
                    <div class="text-xl font-black text-slate-900  tabular-nums"><?php echo e(number_format($totalPolio, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                    <div class="w-full bg-slate-200  h-1.5 rounded-full mt-2 overflow-hidden">
                ...
                <div class="p-4 bg-slate-50  rounded border border-slate-200 ">
                    ...
                    <div class="text-xl font-black text-slate-900  tabular-nums"><?php echo e(number_format($totalSinovac, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Vial</span></div>
                    <div class="w-full bg-slate-200  h-1.5 rounded-full mt-2 overflow-hidden">
                ...
                <div class="p-4 bg-slate-50  rounded border border-slate-200 ">
                    ...
                    <div class="text-xl font-black text-slate-900  tabular-nums"><?php echo e(number_format($totalInsulin, 0, ',', '.')); ?> <span class="text-xs font-medium text-slate-500">Pena/Vial</span></div>
                    <div class="w-full bg-slate-200  h-1.5 rounded-full mt-2 overflow-hidden">
        ...
        <div class="p-4 border-b border-slate-200  flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-50/50 ">
            ...
            <form action="<?php echo e(route('inventory')); ?>" method="GET" class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                ...
                <?php if(request()->anyFilled(['search', 'kecamatan', 'status', 'sort'])): ?>
                    <a href="<?php echo e(route('inventory')); ?>" class="text-rose-500 hover:text-rose-600 :text-rose-400 p-2 hover:bg-rose-500/10 rounded-xl text-xs font-bold transition-all active:scale-95 duration-100 flex items-center gap-1 cursor-pointer">
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-3">
                                    <div class="p-2.5 <?php if($hub['jenis'] === 'Rumah Sakit'): ?> bg-purple-100 text-purple-600   <?php else: ?> bg-teal-100 text-teal-600   <?php endif; ?> rounded-xl">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="font-bold text-slate-900  text-sm mt-0.5"><?php echo e($hub['nama']); ?></h4>
...
<?php $component->withAttributes(['class' => 'font-medium']); ?>
                                <span class="font-semibold text-slate-900 "><?php echo e($hub['kulkas_farmasi']); ?></span>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex flex-wrap gap-1.5 justify-center">
                                    <span class="px-2 py-0.5 rounded bg-slate-100  border border-slate-200  text-slate-600  font-bold font-mono text-[10px]" title="Pfizer">
                                        P: <span class="text-sky-600 "><?php echo e(number_format($hub['stok']['pfizer'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100  border border-slate-200  text-slate-600  font-bold font-mono text-[10px]" title="Polio">
                                        O: <span class="text-indigo-600 "><?php echo e(number_format($hub['stok']['polio'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100  border border-slate-200  text-slate-600  font-bold font-mono text-[10px]" title="Sinovac">
                                        S: <span class="text-emerald-600 "><?php echo e(number_format($hub['stok']['sinovac'], 0, ',', '.')); ?></span>
                                    </span>
                                    <span class="px-2 py-0.5 rounded bg-slate-100  border border-slate-200  text-slate-600  font-bold font-mono text-[10px]" title="Insulin">
                                        I: <span class="text-amber-600 "><?php echo e(number_format($hub['stok']['insulin'], 0, ',', '.')); ?></span>
                                    </span>
                                </div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['colspan' => '7','class' => 'py-12 text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        ...
        <div class="px-4 py-3 border-t border-slate-200  bg-slate-50/50  flex justify-between items-center transition-colors duration-300">
            ...
            <div class="flex gap-2">
                ...
                <?php else: ?>
                    <a href="<?php echo e($hubsPaginated->previousPageUrl()); ?>" class="px-3.5 py-1.5 bg-white  border border-slate-200  text-slate-700  hover:bg-slate-100 :bg-slate-600/70 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95">
                        Sebelumnya
                    </a>
                <?php endif; ?>

                <?php if($hubsPaginated->hasMorePages()): ?>
                    <a href="<?php echo e($hubsPaginated->nextPageUrl()); ?>" class="px-3.5 py-1.5 bg-white  border border-slate-200  text-slate-700  hover:bg-slate-100 :bg-slate-600/70 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95">
                        Berikutnya
                    </a>
                <?php else: ?>
                    <button class="px-3.5 py-1.5 bg-slate-100  text-slate-400  rounded-lg text-xs font-bold cursor-not-allowed" disabled>
...
<div id="add-hub-modal" class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm hidden">
    <div class="relative w-full max-w-2xl bg-white  border border-slate-200  rounded-2xl shadow-2xl p-6 md:p-8 max-h-[90vh] overflow-y-auto">
        ...
        <form action="<?php echo e(route('inventory.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="kecamatan" required class="w-full bg-slate-50  border border-slate-200  rounded-lg px-3 py-2 text-sm text-slate-800 ">
                        <?php $__currentLoopData = $allKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kec); ?>"><?php echo e($kec); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
