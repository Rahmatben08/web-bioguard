        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b-4 border-cyan-500 pb-6 mb-8 gap-4">
                ...
                <div class="text-left sm:text-right">
                    ...
                    <p class="text-xs text-slate-500 font-medium">No. Dokumen: <span class="font-mono font-bold">CERT-CDOB-<?php echo e(date('Ymd-Hi')); ?></span></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 bg-slate-50 rounded-2xl mb-8 border border-slate-200">
                <div>
                    ...
                    <span class="text-xs font-bold text-slate-800"><?php echo e(auth()->user()->name ?? 'Admin Bio-Guard'); ?></span>
                </div>
                <div>
                    <span class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">ID Dispatcher</span>
                    <span class="text-xs font-mono font-bold text-slate-800"><?php echo e(auth()->user()->dispatcher_id ?? 'DSP-PLB-2026'); ?></span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span class="text-xs font-bold text-slate-800"><?php echo e(date('d F Y H:i')); ?> WIB</span>
                </div>
            </div>
                ...
                <div class="border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                    <table class="w-full text-left text-xs border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100 text-slate-800 font-medium">
                            <?php $__empty_1 = true; $__currentLoopData = $perjalananList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perjalanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                ?>
                                <tr>
                                    <td class="px-4 py-3.5 font-mono font-bold text-cyan-600">#<?php echo e($perjalanan->id_box); ?></td>
                                    <td class="px-4 py-3.5">
                                        <div class="font-bold"><?php echo e($perjalanan->kurir->nama_lengkap); ?></div>
                                        <div class="text-[10px] text-slate-400 font-mono"><?php echo e($perjalanan->kurir->nomor_kendaraan); ?></div>
                                    </td>
                                    <td class="px-4 py-3.5 font-bold"><?php echo e($perjalanan->nama_kargo ?? 'Vaksin Medis'); ?></td>
                                    <td class="px-4 py-3.5"><?php echo e($perjalanan->lokasi_tujuan); ?></td>
                                    <td class="px-4 py-3.5 text-center font-mono font-bold text-slate-700">
                                        <?php echo e(number_format($avgTemp, 1, ',', '.')); ?>°C
                                    </td>
                                    <td class="px-4 py-3.5 text-center">
                                        <?php if($excursion['status'] === 'Aman'): ?>
                                        ...
                                        <?php elseif($excursion['status'] === 'Peringatan'): ?>
            ...
            <div class="text-center sm:text-left">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-left font-mono">
                        ...
                        <p class="text-[9px] font-bold text-slate-700 break-all select-all"><?php echo e(hash('sha256', $hashData)); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\project pkm\bio_guard_backend\resources\views\dashboard\audit_pdf.blade.php ENDPATH**/ ?>