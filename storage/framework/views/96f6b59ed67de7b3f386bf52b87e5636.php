<?php $__env->startSection('title', 'Simulator Kurir Telemetri'); ?>
            ...
            <div class="flex flex-col gap-xs text-xs">
                <div class="flex justify-between py-1 border-b border-outline-variant/60">
                    ...
                    <select id="route-selector" class="bg-background text-on-background border border-outline-variant rounded px-1.5 py-0.5 font-mono text-[10px]" onchange="changeRoute(this.value)">
                        <?php $__currentLoopData = $ruteAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rute->id_rute); ?>" data-box="<?php echo e($rute->id_box); ?>" data-tujuan="<?php echo e($rute->lokasi_tujuan); ?>">
                                <?php echo e($rute->id_rute); ?> - <?php echo e($rute->kurir->nama_lengkap); ?>
...
<script>
    ...
    const activeReroutes = {
        <?php $__currentLoopData = $ruteAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            '<?php echo e($rute->id_rute); ?>': <?php echo e($rute->isRerouted() ? 'true' : 'false'); ?>,
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };
    ...
    function syncTelemetryWithServer() {
        ...
        fetch('/api/telemetry/sync', {
            ...
            headers: {
                ...
                'Authorization': `Bearer <?php echo e($apiToken ?? ''); ?>`
            },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project pkm\bio_guard_backend\resources\views\dashboard\simulator.blade.php ENDPATH**/ ?>