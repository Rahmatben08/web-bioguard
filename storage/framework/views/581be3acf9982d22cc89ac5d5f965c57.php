...
<?php $component->withAttributes(['noPadding' => 'true','class' => 'h-full max-h-[60vh] overflow-y-auto']); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $perjalananAktif ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perjalanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="telemetry-card cursor-pointer p-5 rounded-2xl <?php echo e($bgClass); ?> border border-slate-200 dark:border-slate-800/80 <?php echo e($pulseRing ?? ''); ?> hover:shadow-md hover:border-primary/30 transition-all duration-300 ease-out group" data-rute-id="<?php echo e($perjalanan->id_rute); ?>">
...
const plannedPaths = {
    ...
    function renderTelemetryCards(list) {
        ...
        list.forEach(c => {
            ...
            const shakeClass = vibration > 1.50 ? '' : '';
