...
<body class="min-h-screen text-on-surface antialiased relative overflow-x-hidden flex flex-col justify-between">
    ...
    <header class="relative z-10 w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div class="flex items-center gap-3">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="BIO-GUARD Logo" class="h-10 w-auto object-contain select-none drop-shadow-[0_0_10px_rgba(76,213,246,0.25)]">
            <div>
        ...
        <div class="flex items-center gap-4">
            ...
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="px-5 py-2.5 bg-primary text-on-primary font-bold text-xs rounded-xl shadow-lg shadow-primary/20 hover:-translate-y-0.5 active:scale-95 transition-all cursor-pointer">
                        Portal Admin
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-5 py-2.5 bg-primary text-on-primary font-bold text-xs rounded-xl shadow-lg shadow-primary/20 hover:-translate-y-0.5 active:scale-95 transition-all cursor-pointer">
                        Masuk Portal
                    </a>
                <?php endif; ?>
            <?php endif; ?>
    ...
    <main class="relative z-10 w-full max-w-7xl mx-auto px-6 py-12 flex-1 flex flex-col gap-16 justify-center">
        ...
        <section class="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="w-full sm:w-auto px-8 py-3.5 bg-primary text-on-primary text-sm font-bold tracking-wide rounded-xl shadow-lg shadow-primary/20 hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 cursor-pointer flex items-center justify-center gap-2">
                        <span class="material-symbols-outlined text-[20px]">dashboard</span>
                        Buka Dasbor Monitoring
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto px-8 py-3.5 bg-primary text-on-primary text-sm font-bold tracking-wide rounded-xl shadow-lg shadow-primary/20 hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 cursor-pointer flex items-center justify-center gap-2">
                        <span class="material-symbols-outlined text-[20px]">login</span>
                        Masuk Ke Portal Admin
                    </a>
                <?php endif; ?>
                
                <a href="<?php echo e(url('/simulator')); ?>" class="w-full sm:w-auto px-8 py-3.5 bg-white/60  backdrop-blur-md border border-slate-200  text-slate-700  text-sm font-bold tracking-wide rounded-xl hover:-translate-y-0.5 hover:shadow-md active:scale-[0.98] transition-all duration-300 cursor-pointer flex items-center justify-center gap-2">
...
<?php /**PATH C:\project pkm\bio_guard_backend\resources\views\welcome.blade.php ENDPATH**/ ?>