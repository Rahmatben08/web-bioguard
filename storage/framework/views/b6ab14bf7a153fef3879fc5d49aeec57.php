                            ...
                            <div class="flex justify-between items-center py-1 border-b border-white/5">
                                ...
                                <select id="route-selector" class="bg-slate-900 text-slate-200 border border-white/10 rounded px-1.5 py-1 font-mono text-[11px] focus:outline-none focus:border-teal-500" onchange="changeRoute(this.value)">
                                    <?php $__currentLoopData = $ruteAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($rute->id_rute); ?>" data-box="<?php echo e($rute->id_box); ?>" data-tujuan="<?php echo e($rute->lokasi_tujuan); ?>" data-kurir="<?php echo e($rute->kurir->nama_lengkap); ?>">
...
<?php /**PATH C:\project pkm\bio_guard_backend\resources\views\simulator.blade.php ENDPATH**/ ?>