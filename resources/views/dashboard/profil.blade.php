...
<div class="flex-1 w-full min-h-full p-container-margin space-y-lg relative z-10 max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        ...
        <div class="lg:col-span-8 space-y-gutter">
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white/40  backdrop-blur-md rounded-2xl border border-slate-200  p-8 shadow-sm hover:shadow-[0_0_30px_rgba(76,213,246,0.15)] hover:border-primary/30 transition-all duration-500 space-y-6">
                @csrf
