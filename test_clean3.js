...
<div class="p-container-margin space-y-lg">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-md bg-white/40 dark:bg-slate-900/20 backdrop-blur-md border border-slate-200 dark:border-slate-800/60 p-6 rounded-2xl shadow-sm mb-md relative z-40">
        ...
        <div class="flex items-center gap-sm relative">
            ...
            <a href="1" class="inline-flex items-center gap-xs px-md py-[10px] rounded-xl bg-primary text-on-primary text-body-sm font-semibold hover:-translate-y-0.5 hover:shadow-lg active:scale-95 transition-all duration-300 ease-out shadow-[0_0_15px_rgba(2,132,199,0.3)]">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-gutter">
        ...
        <div class="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800/80 p-6 flex items-center gap-md transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:border-primary/40">
            ...
            <div class="min-w-0">
                ...
                <p id="stat-active-couriers" class="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mt-1">1</p>
            </div>
        </div>
        ...
        <div class="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800/80 p-6 flex items-center gap-md transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:border-tertiary/40">
            ...
            <div class="min-w-0">
                ...
                <p id="stat-pending-sync" class="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mt-1">1</p>
            </div>
        </div>
        ...
        <div class="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800/80 p-6 flex items-center gap-md transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:border-green-500/40">
            ...
            <div class="shrink-0" id="stat-alerts-container">
                <span id="stat-alerts-value" class="inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full bg-error-container text-on-error-container text-[10px] font-black uppercase tracking-wider 1">
                    1 Alarm
                </span>
            </div>
        </div>
        ...
        <div class="lg:col-span-4">
            <div class="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800/80 overflow-hidden shadow-sm">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800/60 bg-slate-900/5 dark:bg-slate-100/5">
                    ...
                    <span class="text-xs font-semibold text-slate-500 uppercase tracking-widest">1 aktif</span>
                </div>
                ...
                <div id="telemetry-cards-container" class="max-h-[60vh] overflow-y-auto divide-y divide-slate-200 dark:divide-slate-800/60">
                        ...
                        <div class="telemetry-card telemetry-card-glow-1 cursor-pointer p-6 1 1 1 1 1 border-b hover:bg-slate-100/50 dark:hover:bg-slate-800/30 active:scale-[0.99] transition-all duration-300 ease-out group" data-rute-id="1">
                            1
                            <div class="flex items-start justify-between gap-sm">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-label-md text-slate-500 mt-0.5 flex items-center gap-1">
                                            1 â€¢ 
                                            <span class="font-mono-data text-[10px]">1</span> â€¢
                                            <span class="font-mono-data text-[10px]" title="WhatsApp Kurir">1</span>
                                            <a href="1" target="_blank" class="inline-flex items-center text-primary hover:text-primary/80 transition-all active:scale-90 ml-1" title="Cetak QR Code Boks">
                                ...
                                <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full 1 text-[10px] font-black uppercase tracking-wider shrink-0">
                            ...
                            <div class="flex items-end justify-between mt-sm">
                                <div>
                                    ...
                                    <p class="text-4xl font-extrabold tracking-tight 1">
                            ...
                            <div class="grid grid-cols-3 gap-sm mt-sm pt-sm border-t border-slate-200 dark:border-slate-800/60 text-[10px] font-semibold text-slate-500">
                                <div>
                                    ...
                                    <span class="font-mono-data font-bold block mt-0.5 1">
                                                                                    0s (Normal)
                                                                                    1s
                                                                            </span>
                                </div>
                            ...
                            <div class="mt-sm h-1.5 rounded-full overflow-hidden bg-slate-200 dark:bg-slate-800">
                                <div class="h-full rounded-full transition-all duration-1000 1"
                                     style="width: 1%;">
                                </div>
                            </div>
                        </div>
        ...
        <div class="lg:col-span-4 flex flex-col gap-gutter">
            ...
            <div class="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800/80 p-6 shadow-sm hover:border-slate-350 dark:hover:border-slate-700 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl flex flex-col justify-between mt-sm">
                ...
                <div class="mt-4 space-y-3" id="device-health-list">
                        ...
                        <div class="p-3 bg-slate-100/50 dark:bg-slate-800/40 rounded-xl border border-slate-200/50 dark:border-slate-700/30 flex flex-col gap-2 transition-all hover:border-primary/30" id="device-health-1">
                            <!-- Box ID & Courier -->
                            <div class="flex justify-between items-center text-xs">
                                <span class="font-bold text-slate-900 dark:text-white font-mono">1</span>
                                <span class="text-slate-500 dark:text-slate-400 font-semibold">1</span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 text-[10px]">
                                ...
                                <div class="flex flex-col gap-1">
                                    <div class="flex items-center justify-between font-semibold">
                                        ...
                                        <span class="text-slate-900 dark:text-white font-mono" id="device-battery-val-1">1%</span>
                                    </div>
                                    <div class="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full overflow-hidden">
                                        <div class="h-full 1 rounded-full transition-all duration-500" id="device-battery-bar-1" style="width: 1%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col justify-between">
                                    <div class="flex items-center justify-between font-semibold">
                                        <span class="flex items-center gap-0.5 text-slate-500">
                                            <span class="material-symbols-outlined text-[13px]" id="device-signal-icon-1">1</span> GSM Sinyal
                                        </span>
                                        <span class="text-slate-900 dark:text-white font-mono" id="device-signal-val-1">1 dBm</span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between font-semibold mt-1">
                                        ...
                                        <span class="flex items-center gap-1 font-bold text-[9px] uppercase tracking-wider 1" id="device-calibration-val-1">
                                            <span class="h-1.5 w-1.5 rounded-full 1 inline-block" id="device-calibration-dot-1"></span>
                                            1
                                        </span>
                                    </div>
                                </div>
...
<div id="audit-preview-modal" class="fixed inset-0 z-[2000] hidden flex items-center justify-center p-md bg-black/60 backdrop-blur-sm transition-opacity duration-300 animate-opacity">
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-xl overflow-hidden shadow-2xl scale-95 opacity-0 transition-all duration-300 flex flex-col">
            ...
            <div class="relative border-2 border-dashed border-primary/20 dark:border-primary/10 rounded-2xl p-6 bg-slate-50/50 dark:bg-slate-950/20 backdrop-blur-sm overflow-hidden select-none">
                ...
                <div class="grid grid-cols-2 gap-4 text-xs">
                    ...
                    <div>
                        ...
                        <span class="font-extrabold text-slate-700 dark:text-slate-350">1</span>
                    </div>
        ...
        <div class="px-6 py-4 border-t border-slate-200 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-850 flex justify-end gap-sm">
            ...
            <a href="1" target="_blank" onclick="closeAuditPreviewModal()" class="px-4 py-2 bg-primary text-on-primary hover:-translate-y-0.5 hover:shadow-lg rounded-xl text-xs font-semibold transition-all duration-300 ease-out active:scale-95 shadow-[0_0_10px_rgba(2,132,199,0.2)] cursor-pointer flex items-center gap-1">
...
const plannedPaths = {
    ...
    // Swap planned path dynamically on load if rerouted
                        if (alternativePaths['1']) {
                plannedPaths['1'] = alternativePaths['1'];
            }
    ...
    function processLiveData(list, stats) {
        ...
        filteredList.forEach(c => {
            ...
            // For BOX-002, simulate deviation by adding coordinate offset
            if (c.id_box === 'BOX-002' && !activeReroutes[ruteId]) {
                currentLatLng = [lat - 0.005, lng + 0.009];
            }
    ...
    const initialList =     const bootstrapData = initialList.map(p => {
